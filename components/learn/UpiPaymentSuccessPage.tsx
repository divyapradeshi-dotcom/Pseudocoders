...
export function UpiPaymentSuccessPage({
  amount,
}: {
  contact: {
    name: string;
      ...
      <div className="mx-auto flex w-full max-w-5xl flex-col items-center gap-10 text-center">
        ...
        <section className="space-y-5">
          ...
          <p className="max-w-4xl text-2xl leading-10 text-slate-900">
            You verified all details before sending money. Always check the recipient&apos;s name and phone number before confirming UPI payments.
          </p>
        </section>
        ...
        <section className="w-full rounded-[2rem] bg-white px-8 py-12 shadow-[0_10px_30px_rgba(15,23,42,0.1)]">
          ...
          <p className="mt-6 text-xl text-slate-400">Payment amount: Rs{amount}</p>
        </section>
