...
const items = [
  {
    ...
    description: "Use Practo, Apollo safely",
    icon: Calendar,
    iconClassName: "bg-emerald-500",
  },
  {
    title: "Order Medicines Online",
    description: "Verify pharmacy websites",
    icon: Pill,
    iconClassName: "bg-blue-500",
  },
  {
    title: "Spot Fake Health Advice",
    description: "Check if medical tips are trustworthy",
    icon: ShieldAlert,
    iconClassName: "bg-red-500",
  },
];

export function HealthcareMedicinePage() {
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#f3fff7_0%,#f7fbff_100%)] px-4 py-8 text-slate-950 sm:px-6 lg:px-8">
      <div className="mx-auto flex w-full max-w-5xl flex-col gap-8">
        <section className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-3 text-lg text-slate-500 sm:text-xl">
              Stay safe with online health services
            </p>
          </div>
          <button
            type="button"
        ...
        <section className="rounded-[2rem] border border-blue-200 bg-blue-100/80 p-8 shadow-[0_10px_30px_rgba(15,23,42,0.08)]">
          <div className="flex items-start gap-4">
            ...
            <p className="text-xl leading-9 text-blue-800 sm:text-2xl">
              This module is coming soon! Learn to book appointments, order medicines, and spot fake health advice online.
            </p>
          </div>
        </section>
        ...
        <div className="pt-2">
          <Link
            href="/"
            className="inline-flex w-full items-center justify-center rounded-[1.5rem] bg-slate-900 px-6 py-5 text-xl font-semibold text-white transition-colors hover:bg-slate-800"
          >
            Back to Home Page
          </Link>
        </div>
