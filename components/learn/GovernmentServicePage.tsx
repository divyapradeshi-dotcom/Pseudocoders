...
import { Globe, IdCard, Info, FileText, Volume2 } from "lucide-react";

const items = [
  {
    title: "Aadhaar Safety",
    description: "Protect your Aadhaar details",
    icon: IdCard,
    iconClassName: "bg-blue-600",
  },
  {
    title: "PAN Card Security",
    description: "Use PAN safely online",
    icon: FileText,
    iconClassName: "bg-gradient-to-br from-violet-600 to-fuchsia-500",
  },
  {
    title: "Government Portals",
    description: "Access DigiLocker, UMANG safely",
    icon: Globe,
...
export function GovernmentServicePage() {
  return (
    <main className="min-h-screen bg-[linear-gradient(180deg,#faf7ff_0%,#f7fbff_100%)] px-4 py-8 text-slate-950 sm:px-6 lg:px-8">
        ...
        <section className="flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-3 text-lg text-slate-500 sm:text-xl">
              Stay safe using official digital services
            </p>
          </div>
          <button
            type="button"
        ...
        <section className="rounded-[2rem] border border-blue-200 bg-blue-100/80 p-8 shadow-[0_10px_30px_rgba(15,23,42,0.08)]">
          <div className="flex items-start gap-4">
            ...
            <p className="text-xl leading-9 text-blue-800 sm:text-2xl">
              This module is coming soon! Learn to protect your Aadhaar, PAN, and use government e-services safely.
            </p>
          </div>
        </section>
